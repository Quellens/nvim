--  NOTE: This is a kickstarter fork with many custom plugins
vim.g.mapleader = ' '
...
-- Visual Mode Moving selected text up and down
...
-- paste without loosig current yank
...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          -- VS Code like Colorizer for css
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      local parsers = { 'bash', 'c', 'diff', 'gitcommit', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' }
